...
- Prepared frontier reasoning packet: [`benchmarks/runs/2026-05-17-batch-01/frontier-run-packets/2026-05-18-strategic-gated-diligence-frontier-r1.md`](./benchmarks/runs/2026-05-17-batch-01/frontier-run-packets/2026-05-18-strategic-gated-diligence-frontier-r1.md). The direct-answer and light-structured frontier outputs have been harvested and reviewed; the full-OfOne frontier arm is not launched or aggregate evidence until its raw output is harvested, validated where applicable, reviewed, committed, pushed, and Pages-confirmed.
...
- First frontier reasoning light-structured result: [`raw output`](./benchmarks/runs/2026-05-17-batch-01/outputs/2026-05-17-batch-01__case-strategic-gated-diligence-001__light_structured__frontier_reasoning__r1.md), [`local review`](./benchmarks/reviews/2026-05-17-batch-01/2026-05-17-batch-01__case-strategic-gated-diligence-001__light_structured__frontier_reasoning__r1.md). These are two aggregate-eligible `frontier_reasoning` text slots only; no frontier full-OfOne result and no aggregate comparison or superiority claim is supported.
