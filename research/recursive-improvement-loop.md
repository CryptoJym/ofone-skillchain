...
- Latest bounded action: remedial `full_ofone` benchmark rerun 1 for `case-strategic-gated-diligence-001`, all five `agentic_coding` repeat-1 slices, all five `agentic_coding` repeat-2 slices, all five `agentic_coding` repeat-3 slices, and all three `frontier_reasoning` strategic repeat-1 arms have been produced under the hardened workflow. The frontier direct-answer arm completed in ChatGPT Deep Research at https://chatgpt.com/c/6a0e3e09-fd6c-83e8-a914-36445d70d090 with visible report metadata `Research completed in 17m`, `6 citations`, and `81 searches`; its raw Markdown and local review are harvested, committed, pushed, and Pages-confirmed in Batch 01. The frontier light-structured arm completed at https://chatgpt.com/c/6a0e7bcd-43b0-83e8-9a92-5195521c42fe with visible completed report title `Benchmark Raw Output` and run metadata `Status: completed`; its raw Markdown and local review are harvested, committed in `7d3f545`, pushed, and Pages-confirmed. The frontier full-OfOne arm completed at https://chatgpt.com/c/6a0e8476-9f6c-83e8-b201-ff3f97fae18b with visible metadata `Research completed in 18m`, `5 citations`, and `9 searches`; its raw Markdown, artifact JSON, computed validator JSON, rendering, patch report, and local review were harvested, committed in `373198f`, pushed, and Pages-confirmed. The Pages checker was extended in `2099f89` so those frontier full-OfOne evidence files are covered by public parity checks. The full-OfOne frontier slot is excluded before aggregate scoring because computed semantic validation failed. The remedial frontier full-OfOne rerun 1 completed at https://chatgpt.com/c/6a0e8efd-2234-83e8-af43-a7e25266034d with visible metadata `Research completed in 1h 7m`, `10 citations`, and `117 searches`, but the exported result was an advisory research report, not the required benchmark raw output package. It was harvested as immutable evidence and rejected before artifact extraction, matrix insertion, or aggregate eligibility. Remedial frontier full-OfOne rerun 2 completed at https://chatgpt.com/c/6a0ea350-3584-83e8-9d3e-ab7759c489f6 with visible metadata `Research completed in 44m`, `1 citation`, and `20 searches`; its raw Markdown, artifact JSON, computed validator JSON, rendering, patch report, and local review are harvested, but computed validation failed required evidence `movement_jobs` and tradeoff reversal-condition checks. Rerun 2 is rejected before aggregate scoring and is not inserted into the execution matrix. Remedial frontier full-OfOne rerun 3 is active in ChatGPT Deep Research at https://chatgpt.com/c/6a0eb57b-6b08-83e8-a3e2-16e26adc497f after clean launch proof; its packet is at `benchmarks/runs/2026-05-17-batch-01/frontier-run-packets/2026-05-21-strategic-gated-diligence-frontier-full-r1-rerun3.md`, and `docs/object-schemas.md` now shows `movement_jobs` in the Evidence example.
- Next bounded action: monitor remedial frontier full-OfOne rerun 3 until a completed-report surface exists, then harvest and validate it before any review, matrix insertion, or aggregate eligibility. Do not grant aggregate eligibility to the frontier full-OfOne replacement unless rerun 3 passes executable validation and review. Superiority claims remain blocked.
