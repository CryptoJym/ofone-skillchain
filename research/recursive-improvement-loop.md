...
- Latest bounded action: remedial `full_ofone` benchmark rerun 1 for `case-strategic-gated-diligence-001`, all five `agentic_coding` repeat-1 slices, all five `agentic_coding` repeat-2 slices, all five `agentic_coding` repeat-3 slices, and all three `frontier_reasoning` strategic repeat-1 arms have been produced under the hardened workflow. The frontier direct-answer and light-structured arms are harvested, reviewed, committed, pushed, Pages-confirmed, and aggregate-eligible. The original frontier full-OfOne arm completed at https://chatgpt.com/c/6a0e8476-9f6c-83e8-b201-ff3f97fae18b, but it is excluded before aggregate scoring because computed semantic validation failed. Remedial frontier full-OfOne reruns 1-4 are preserved as failed immutable evidence outside aggregate scoring and outside replacement eligibility. Controlled Mode A rerun 5, `2026-05-17-batch-01__case-strategic-gated-diligence-001__full_ofone__frontier_reasoning__r1__rerun5`, is validator-valid, locally reviewed, recorded in `remedial_runs` as `replace_for_aggregate_only` replacement evidence, committed in `7068ea8`, pushed, and Pages-confirmed. The `case-regulated-wastewater-market-entry-001` / `full_ofone` / `frontier_reasoning` / repeat 1 arm is active in ChatGPT Deep Research at https://chatgpt.com/c/6a0ee4ad-8854-83e8-866e-f671c12880da with step 1 complete, step 2 active, status `Addressing potential issues and refining schema elements...`, `17 searches`, `17 sources searched`, and `Stop research` present.
- Next bounded action: observe the active clean isolated `case-regulated-wastewater-market-entry-001` / `full_ofone` / `frontier_reasoning` / repeat 1 arm under the Active Research Watchdog, then harvest only after a completed report is visible. The direct-answer and light-structured regulated wastewater frontier text arms are harvested, locally reviewed, committed in `1ffcf96`, pushed, Pages-confirmed, and aggregate-eligible. The full-OfOne regulated wastewater frontier arm is launched but not harvested, reviewed, complete, or aggregate-eligible. For the repaired strategic frontier full-OfOne slot, do not launch another same-shape Deep Research remedial rerun. Superiority claims remain blocked.
