...
- Next bounded action: do not launch another same-shape Deep Research remedial rerun. Apply the repair protocol, then move the frontier full-OfOne replacement to a controlled non-Deep-Research execution path or a fully inline Deep Research launch contract that can actually emit the required artifact package. Superiority claims remain blocked.
