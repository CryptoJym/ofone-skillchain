...
| strategic / `full_ofone` / `frontier_reasoning` / repeat 1 / remedial rerun 3 | prepared only | Prompt packet is prepared-not-launched; no output, review, or aggregate eligibility exists. |
