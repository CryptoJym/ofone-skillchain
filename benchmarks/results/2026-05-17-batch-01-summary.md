...
| strategic / `full_ofone` / `frontier_reasoning` / repeat 1 / remedial rerun 3 | active researching | Deep Research launch proof exists; no completed output, review, or aggregate eligibility exists. |
