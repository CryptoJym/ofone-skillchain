...
The next `frontier_reasoning` slice is `case-formal-proof-search-001` repeat 1 at `benchmarks/runs/2026-05-17-batch-01/frontier-run-packets/2026-05-21-formal-proof-search-frontier-r1.md`. It was launched in ChatGPT Deep Research at https://chatgpt.com/c/6a0f0a85-c75c-83e8-b0d0-4c15a041cb7b through the Chrome extension plugin, but the latest Chrome-extension observation is `observation_blocked`: the internal Deep Research iframe is mounted while no completed report, active progress text, stop control, or response text is visible. No formal frontier slot is complete until completed-report harvest, local review, and publication.
