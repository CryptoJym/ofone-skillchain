...
The `frontier_reasoning` regulated wastewater repeat-1 slice has direct-answer, light-structured, and full-OfOne outputs. The direct-answer and light-structured outputs are harvested, reviewed, and aggregate-eligible. The full-OfOne output is harvested, reviewed, and excluded before aggregate scoring because computed local semantic validation failed relation legality and relation-family checks.
